...
function Lights(sSelector)
{
	...
	s.RotateFunction=function(event)
	{

		var PreviewNumber=$(this).attr('data-number');
		
		s.Mainimage.css("background-image",$(event.target).css("background-image"));//firefox Не хочет выполнять
	...
	$('.miniicon').click(s.RotateFunction);
